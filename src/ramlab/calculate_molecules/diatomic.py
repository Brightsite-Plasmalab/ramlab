...
class SimpleDiatomicMolecule(AbInitioMolecule):
    """Applicable to homonuclear diatomic calculate_molecules.
    ...
    @classmethod
    @override
    def population(cls, state_initial, **temperatures) -> float:
        ...
        if len(temperatures) <= 1:
            ...
            return super().population(state_initial, **temperatures)
    ...
    def _get_all_transition_states(cls) -> tuple[State, State]:
        states_initial, states_final = cls.all_states().transition_each(
