...
import numpy as np
from ramlab.calculate_molecules.custom_linelist_molecule import CustomLinelistMolecule
...
class H2(SimpleDiatomicMolecule):
    ...
    @classmethod
    def all_states(cls):
        return State(J=np.arange(0, 16)).add_each(v=np.arange(0, 5))
