...
from ramlab.data_parsing.lineformatter import format_transitions_initial_final
...
class AbInitioMolecule(LineListMolecule):
    """A class for calculate_molecules with ab initio linelists. The line list are not shipped with the package, but are generated.
    ...
    @abstractproperty
    def molecule_number(self) -> int:
        return self.molecule_number
    ...
    @abstractproperty
    def isotope_number(self) -> int:
        """The isotope number according to the HITRAN database."""
        return self.isotope_number  # placeholder - probably correct anyway
    ...
    def _make_transitions(
        ...
        if "O" in state_initial.state.keys():
            ...
            # Sum of spin and electronic orbital angular momentum
            ...
            # Sum of rotational and electronic angular momentum
