...
class CombinedMolecule:
    ...
    Example usage:
        ```python
        from ramlab.calculate_molecules.base import Molecule
        from ramlab.state.transitions import Transitions
        from ramlab.state.polarisation import Polarisation
    ...
    def __init__(
        ...
        **molecules: Dict[AnyStr, Tuple[type[Molecule], Transitions]],
        ...
        """
        Initialize CombinedMolecule with given calculate_molecules and polarisation.
...
def combine_molecules(
    ...
    """
    Combine stick spectra from multiple calculate_molecules into a single spectrum.
    ...
    Example usage:
        ...
        dnu_stick, lambda_stick, I_stick_sim = combine_molecules(calculate_molecules, T=300)
    """
    I_stick_sim = []
    dnu_stick = []
    if I_const is None:
