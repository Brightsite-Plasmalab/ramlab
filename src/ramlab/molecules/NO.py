...
class NO(AbInitioMolecule):
    ...
    # Quantum numbers definitions - see Zare - Angular Momentum, P29
        ...
        JI = RI + SI + LI
        JF = RF + SF + LF
        PI = (-1)**(JI + SI) #e states have (-1)^J-1/2, f states have (-1)^J+1/2. Brown and Carrington P 251.
        PF = (-1)**(JF + SF) #e states have (-1)^J-1/2, f states have (-1)^J+1/2. Brown and Carrington P 251.
